        ...
        <nav className="navbar fixed-top navbar-expand-md navbar-dark bg-dark" >
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <Link to='/9e6591ba-a363-4614-9231-9d9fd1109bce' className="nav-link">Ready</Link>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <Link to='/d5ce744c-9c83-436c-8fe9-718bd82662ac' className="dropdown-item">Festivals</Link>
                        </div>  
                    </li>
                    <li className="nav-item">
                        <Link to='/168126ef-a983-469b-b0d0-6ec65ced1c36' className="nav-link">Eat</Link> 
                    </li>
